...
def get_user_data():
    ...
    total_months = st.number_input("Enter the total number of months:", min_value=1, step=1)
   
    # Get the start date from the user
    start_date = st.date_input("Enter the start date:", min_value=pd.to_datetime("2000-01-01"))
